...
│   ├── officials_data.py        # Static dataset of public officials' portfolios
│   ├── requirements.txt
│   └── api/
...
- The officials dataset is static/curated. In production this would pull from SEC EDGAR / Senate Financial Disclosures.
